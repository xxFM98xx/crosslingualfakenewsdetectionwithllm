...
class ARGModel(torch.nn.Module):
    def __init__(self, config):
        ...
        self.bert_content = XLMRobertaModel.from_pretrained(config['bert_path']).requires_grad_(False)
        self.bert_FTR = XLMRobertaModel.from_pretrained(config['bert_path']).requires_grad_(False)
        ...
        self.mlp = MLP(config['emb_dim'], config['model']['mlp']['dims'], config['model']['mlp']['dropout']) #changed config['model']['mlp']['dims'] to config['model']['mlp']['embed_dims']
